...
export const chatAgent = {
    async run(input) {
        ...
        const system = "Bạn là ChatSF — trợ lý AI tiếng Việt. Trả lời ngắn gọn, rõ ràng, đúng trọng tâm. " +
            "Nếu có ngữ cảnh tham khảo thì ưu tiên dựa vào đó, và không bịa nguồn.";
        const userPrompt = `Câu hỏi của người dùng:\n${input.message}` +
            contextBlock +
